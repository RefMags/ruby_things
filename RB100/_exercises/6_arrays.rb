...
arr.index(5) # index returns the index of a specified element therefor the index of the element 5 from the arr is 3.
...
schools.each_with_index do |index, value|
  puts "#{value}. #{index}"
end
